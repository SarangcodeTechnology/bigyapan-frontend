            ...
            <v-col  class="pa-6" cols="6">
              <v-list >
                ...
                <v-list-item-group
                  ...
                  v-model="selectedItemSubCategory"
                  color="primary"
                >
                  <v-list-item
  ...
  computed:{
    ...
    itemSubCategories: function () {
      ...
      this.itemCategories.forEach(function (itemCategory) {
        if (itemCategory.id === temp.selectedItemCategory.id) {
    ...
    nameErrors () {
      ...
      !this.$v.item_name.maxLength && errors.push('Name must be at most 10 characters long')
    ...
    descriptionErrors(){
      ...
      !this.$v.item_description.maxLength && errors.push('Name must be at most 40 characters long')
      !this.$v.item_description.required && errors.push('Item description is required.')
      return errors
    },
    ...
    priceErrors () {
      ...
      !this.$v.price.numeric && errors.push('Must be valid Price')
